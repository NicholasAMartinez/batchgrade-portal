/**
 * Complete Google OAuth in a single component. It uses the createClient to get 
...
export function GoogleAuthButton() {
  ...
  const provider = "google" as Provider;  // This will change depending on the provider.
